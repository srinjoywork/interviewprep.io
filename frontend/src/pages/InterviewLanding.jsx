...
import codecollaboration from "../assets/interviewroom.png"; // Ensure you provide the correct path for the image

const Interviewlandingbeforesignup = () => {
      ...
      <section className="w-full pt-12 md:pt-24 lg:pt-32 bg-gradient-to-br from-[#191714] to-[#2234AE] pb-20">
        <div className="px-4 md:px-6 space-y-10 xl:space-y-16">
          ...
          <img
            ...
            height="450"
            src={codecollaboration} // Ensure the image is in the correct location
            width="900"
          />
        </div>
      </section>
...
export default Interviewlandingbeforesignup;
