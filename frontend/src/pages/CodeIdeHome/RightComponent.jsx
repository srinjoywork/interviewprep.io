...
const RightComponent = () => {
  ...
  <CardContent>
    ...
    <p>
      Creation Date:{" "}
      {playground.creationDate
        ? new Date(playground.creationDate).toLocaleDateString()
        : "N/A"}
    </p> {/* Ensure creationDate exists and format it */}
  </CardContent>
</CardContainer>
