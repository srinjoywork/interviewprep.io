...
export const Chat = () => {
  ...
  const handleSubmit = async (message) => {
    ...
    try {
      ...
      setChatHistory([...chatHistory, { user: message, bot: generatedText }]);
      speak(generatedText);
    } catch (error) {
          ...
          <div id="container">
            <div className="container-inner">
              ...
              <div className="input-container">
                ...
                <button type="button" onClick={() => handleSubmit(userInput)} disabled={loading}>
                  {loading ? "Sending..." : "Send"}
                </button>
              </div>
              {chatHistory.length > 0 && (
                <div className="buttons">
                  <button type="button" className="confirm" onClick={toggleInput}>
                    Close
                  </button>
